#!/usr/bin/env bun
/**
 * Process anime emotion images for Tidbyt (64x32)
 */
...
const SOURCE_DIR = '/tmp/anime/best';
const TARGET_DIR = join(import.meta.dir, '../assets/anime');
...
async function main() {
  ...
  console.log(`Processing ${files.length} anime images to ${TIDBYT_WIDTH}x${TIDBYT_HEIGHT}...`);
